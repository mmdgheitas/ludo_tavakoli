...
class AppConfig {
  ...
  static String get apiBaseUrl {
    ...
    if (defaultTargetPlatform == TargetPlatform.android) return 'http://217.144.106.247:3001/api/v1';
    return 'http://127.0.0.1:3001/api/v1';
  }
  ...
  static String get socketBaseUrl {
    ...
    if (defaultTargetPlatform == TargetPlatform.android) return 'http://217.144.106.247:3001';
