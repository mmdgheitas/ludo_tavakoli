...
class UpperController extends RectangleComponent with HasGameReference<Ludo> {
  ...
  void showPointer(PlayerTeam playerId) {
    _leftPointer.isActive = playerId == PlayerTeam.red;
    _rightPointer.isActive = playerId == PlayerTeam.green;
  }

  void hidePointer(PlayerTeam playerId) {
    if (playerId == PlayerTeam.red) _leftPointer.isActive = false;
    if (playerId == PlayerTeam.green) _rightPointer.isActive = false;
  }
